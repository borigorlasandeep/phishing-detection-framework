...
def train_sms_model():
    ...
    # Use Random Forest for much better boundary learning on small TF-IDF datasets
    model = RandomForestClassifier(n_estimators=100, random_state=42)
    model.fit(X, y) # Fit on full dataset to ensure memorization of critical demo patterns
